  ...
  app.post('/placeOrder',(req,res)=>{
    ...
    pg.orders
      ...
      .createOrders({
        ...
        orderAmount: req.body.orderAmount, // required
    
        orderCurrency: 'INR',
    
        orderNote: 'Subscription',
    
        customerName: req.body.customerName, // required
    
        customerPhone: req.body.customerPhone, // required
    
        customerEmail: req.body.customerEmail, // required
